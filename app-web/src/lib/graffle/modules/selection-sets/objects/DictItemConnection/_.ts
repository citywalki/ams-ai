...
export type * as DictItemConnection from './__.js'
...
* | **Fields** | 5 |
*/
export interface DictItemConnection<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$DictItemConnection} |
