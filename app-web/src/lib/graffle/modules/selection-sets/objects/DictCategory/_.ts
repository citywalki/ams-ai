...
export type * as DictCategory from './__.js'
...
* | **Fields** | 10 |
*/
export interface DictCategory<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$DictCategory} |
* | **Path** | `DictCategory.id` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$DictCategory} |
* | **Path** | `DictCategory.itemCount` |
* | **Nullability** | Required |
*/
itemCount?: $Fields.itemCount.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.itemCount<_$Context>> | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
