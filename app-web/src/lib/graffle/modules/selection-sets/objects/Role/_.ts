...
export type * as Role from './__.js'
...
* | **Fields** | 5 |
*/
export interface Role<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$Permission}[] |
...
* | **List** | Yes |
*/
permissions?: $Fields.permissions.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.permissions<_$Context>>
