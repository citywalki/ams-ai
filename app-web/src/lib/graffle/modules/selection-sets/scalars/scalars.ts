...
export type Long<$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = Nullable<$Scalar<'Long', $Context>>
export type Long$NonNull<$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = NonNull<$Scalar<'Long', $Context>>