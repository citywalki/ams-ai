...
export const Long = { kind: 'Scalar', name: 'Long', codec: $$Utilities.Codec.create({ encode: (value: any) => String(value), decode: (value: any) => String(value) }) } as $$Utilities.GraphqlKit.Schema.Type.Scalar<'Long', string, string>
export type Long = $$Utilities.GraphqlKit.Schema.Type.Scalar<'Long', string, string>
