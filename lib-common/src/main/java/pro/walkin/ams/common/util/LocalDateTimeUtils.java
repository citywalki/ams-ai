...
public class LocalDateTimeUtils {
    ...
    public static LocalDateTime startOfWeek(LocalDateTime localDateTime) {
        return localDateTime.with(TemporalAdjusters.previousOrSame(java.time.DayOfWeek.MONDAY))
                .toLocalDate()
                .atStartOfDay();
    }

    public static LocalDateTime endOfWeek(LocalDateTime localDateTime) {
        return localDateTime.with(TemporalAdjusters.nextOrSame(java.time.DayOfWeek.SUNDAY))
                .toLocalDate()
