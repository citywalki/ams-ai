...
/**
 * Alert fingerprint calculator for deduplication.
 * Converts normalized labels into MD5 hash by excluding dynamic fields.
 */
public final class AlertFingerprinter {
    ...
    public static String calculate(Map<String, String> data) {
        ...
        TreeMap<String, String> identityFields = data.entrySet().stream()
        ...
        String rawString = identityFields.entrySet().stream()
