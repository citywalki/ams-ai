...
public class MenuInitializer extends DataInitializer {
  ...
  public void initialize() {
    ...
    Menu rootFolder =
        createMenu(
            tenant, ROOT_MENU_KEY, "Root", null, null, 0, List.of(), Menu.MenuType.FOLDER, null);
  ...
  private void migrateMenusToRoot(Tenant tenant, Menu rootFolder) {
    ...
    List<Menu> orphanMenus =
        Menu_.repo()
            .list("parentId is null and key != ?1 and tenant = ?2", ROOT_MENU_KEY, tenant.id);
