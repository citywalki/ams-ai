...
import pro.walkin.ams.boot.initializer.*;
...
public class SecurityConfig {
  ...
  @Inject PermissionInitializer permissionInitializer;

  @Inject RoleInitializer roleInitializer;

  @Inject MenuInitializer menuInitializer;

  @Inject UserInitializer userInitializer;
